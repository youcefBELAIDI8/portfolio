export const projects = [
  ...
  {
    title: 'Sesame',
    description: "Intervention sur un projet pour l’association Voisin Malin en leur fournissant une application pour gérer leur missions, enquêtes et sessions de porte à porte.",
